<template>
    <button @click="toggleColorScheme" aria-label="Toggle color scheme">
        <svg v-if="colorScheme === 'dark'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="icon">
        ...
        <svg v-if="colorScheme === 'light'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="icon">
